...
define method client-class-for-element-type
    (class == <TCP-socket>, element-type == <byte>) => (class :: singleton(<byte-TCP-socket>))
  <byte-TCP-socket>
end method;

define method client-class-for-element-type
    (class == <TCP-socket>, element-type == <byte-character>) => (class :: singleton(<byte-char-TCP-socket>))
  <byte-char-TCP-socket>
end method;

define method client-class-for-element-type
    (class == <TCP-socket>, element-type :: <type>) => (class :: singleton(<general-TCP-socket>))
  <general-TCP-socket>
end method;
...
define class <byte-char-TCP-socket>
    (<TCP-socket>,
     ...
     <sealed-object>)
  constant slot stream-element-type :: <type> = <byte-character>;
...
define method server-class-for-protocol (protocol == #"TCP")
 => (class :: singleton(<TCP-server-socket>))
  <TCP-server-socket>
end method;
