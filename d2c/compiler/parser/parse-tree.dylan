...
// <copy-down-arguments-parse> -- exported.
//
define class <copy-down-arguments-parse> (<expression-parse>)
  //
  // The parameter list.
  constant slot copy-down-parameters :: <parameter-list>,
    required-init-keyword: parameters:;
end class <copy-down-arguments-parse>;

define sealed domain make (singleton(<primitive-parse>));

define sealed method print-object
    (copy-down :: <copy-down-arguments-parse>, stream :: <stream>) => ();
  pprint-fields(copy-down, stream,
                parameters: copy-down.copy-down-parameters);
end method print-object;
